...
class combat_test extends AnyFreeSpec with Matchers {
    ...
    "world-at-war" in {
        ...
        simulate( new FightGlobal( params ) ) 
        {
            ...
            dut.io.in_n.bits.fleet_hp.poke(10.U)
            ...
            dut.io.in_e.bits.fleet_hp.poke(10.U)
            ...
            println("n_out hp is "  + dut.io.out.out_n.bits.fleet_hp.peekValue().asBigInt)
            println("e_out hp is "  + dut.io.out.out_e.bits.fleet_hp.peekValue().asBigInt)
