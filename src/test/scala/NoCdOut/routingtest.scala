...
class router_test extends AnyFreeSpec with Matchers {
    ...
    "basics" in {
        ...
        simulate( new Router( params, 2.U, 2.U) ) 
        {
            ...
            dut.io.packets_in.in_n.bits.src.x.poke(4.U)
            ...
            dut.io.packets_in.in_e.bits.src.x.poke(1.U)
            dut.io.packets_in.in_e.bits.src.y.poke(2.U)
            ...
            dut.io.packets_in.in_s.bits.src.x.poke(3.U)
            dut.io.packets_in.in_s.bits.src.y.poke(3.U)
            ...
            dut.io.packets_in.in_w.bits.src.x.poke(2.U)
            dut.io.packets_in.in_w.bits.src.y.poke(2.U)
            dut.io.packets_in.in_w.bits.dst.x.poke(2.U)
            dut.io.packets_in.in_w.bits.dst.y.poke(3.U)
            ...
            dut.io.planet_in.bits.src.x.poke(1.U)
            dut.io.planet_in.bits.src.y.poke(1.U)
