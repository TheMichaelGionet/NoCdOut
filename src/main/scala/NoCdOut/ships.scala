...
class ShipLut( params : GameParameters ) extends Module
{
    ...
    options(ShipClasses.scout).log_attack_per_hp        := -2.S
    ...
    options(ShipClasses.attack).log_attack_per_hp       := 2.S
    ...
    options(ShipClasses.defence).log_attack_per_hp      := -2.S
    ...
    options(ShipClasses.beefer).log_attack_per_hp       := 1.S
    ...
    options(ShipClasses.destroyer).log_attack_per_hp    := 2.S
